...
fun main() {
    println(minAndMax(987234))  // Output: 11
    println(minAndMax(8812334))  // Output: 9
    println(minAndMax(10))  // Output: 1
}

fun minAndMax(input: Int): Int {
    val digits = input.toString().toCharArray().map { it.toString().toInt() }
