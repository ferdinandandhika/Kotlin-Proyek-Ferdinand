...
fun main() {
    println(getMiddleCharacters("dicoding"))
    println(getMiddleCharacters("dicodingindonesia"))
    println(getMiddleCharacters("A"))
}
...
fun getMiddleCharacters(input: String): String {
    ...
    return if (length % 2 == 0) {
        input.substring(middleIndex - 1, middleIndex + 1)
    } else {
        input.substring(middleIndex, middleIndex + 1)
    }
}
